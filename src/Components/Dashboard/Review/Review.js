...
const Review = () => {
    ...
    const onSubmit = data => {
        ...
        fetch('https://rocky-plains-35683.herokuapp.com/addReview', {
            method: 'POST',
            headers: {
                ...
                <div className="col-md-5 col-sm-12 col-12 d-flex justify-content-center">
                    <div style={{ margin: '30px', borderRadius: '20px', backgroundColor: '#FFFFFF', fontWeight: 'bold' }}>
                        ...
                        <form className="d-flex row" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <input style={{ width: '30%', marginLeft: '15%', backgroundColor: '#3360D4', padding: '10px', borderBottom: '5px solid #3DFFC8',borderRadius:'20px' }} className="submitBtn" type="submit" />
                        </form>
                    </div>
                </div>
            </div>
